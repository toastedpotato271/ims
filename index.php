<?php 
$page_title = "GRP3. - Incident Management Systems";
$additional_css = [
    'assets/css/home.css',
	'assets/css/footer.css'
];
include 'assets/partials/header_home.php'; 
?>
			...
			<div class="hero-inner">
				<div class="hero-copy">
					...
					<div class="hero-form field field-grouped">
						<div class="control">
							<a class="button button-primary button-block" href="assets/pages/report.php">Report Here</a>
						</div>
					</div>
				</div>
...
<?php 
$additional_js = [
    '/ims-sqe/assets/js/home.js'
];
include 'assets/partials/footer_home.php'; 
?>
